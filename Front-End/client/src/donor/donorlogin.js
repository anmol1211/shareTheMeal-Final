          ...
          <div className="card" style={{borderRadius: "1rem" , backgroundColor: "#1B1B1B"}} >
            <div className="row g-0">
              <div className="col-md-6 col-lg-5 d-none d-md-block">
                <img
                  src="https://thumbs.dreamstime.com/z/sharing-food-to-people-foos-donation-concept-man-hand-holding-box-full-flat-design-vector-illustration-white-backg-196293154.jpg"
                  alt="login form"
              ...
              <div className="col-md-6 col-lg-7 d-flex align-items-center">
                <div className="card-body p-4 p-lg-5 text-black">
                  ...
                  <form>
                    ...
                    <a href="/donorReg">don't have account ? Sign Up Here!</a>
                    <h6 class="mt-4">
