...
function ViewGround() {
  ...
  const getAllGrounds = async () => {
    ...
    const response = await axios.get("http://localhost:8000/companyProducts");
          ...
          <div class="mt-5">
            ...
            >
              ...
              <div class="col-12 row">
                ...
                <p class="col-5 h5 mt-3"><b><i>Name Of Product :</i></b> {item.fname}</p>
                <hr/>
                <p class="col-5 h5 mt-3">Price : {item.fprice}</p>
                <p class="col-5 h5 mt-3 ">Quantiy : {item.fqty}</p>
                <hr/>
                <div className="row">
                <div className="col">
                <button className="btn btn-dark " type="button">Cart</button>
                </div>
                {/* <pre/> */}
                <div className="col">
                <button className="btn btn-dark " type="button">Buy</button>
                </div>
                </div>
