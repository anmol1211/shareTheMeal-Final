...
function Login() {
  ...
  const finduser = async () => {
    const user = { cemail: Email, cpassword: Password };

    const response = await axios.post("http://localhost:8000/customers/login", user);
          ...
          <div className="card" style={{borderRadius: "1rem" , backgroundColor: "#1B1B1B"}} >
            <div className="row g-0">
              <div className="col-md-6 col-lg-5 d-none d-md-block">
                <img
                  src="https://previews.123rf.com/images/apolinarias/apolinarias1801/apolinarias180100009/93680521-stop-wasting-food-color-vector-illustration-love-food-and-hate-waste-.jpg"
                  alt="login form"
